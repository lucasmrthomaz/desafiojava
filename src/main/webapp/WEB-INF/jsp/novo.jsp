...
<div class="container" style="width: 50%;">
    ...
    <div>
        ...
        <form id="project-form">
            ...
            <input class="form-control" id="data-inicio" type="date" required/> <br>

            <label for="previsao-termino">Data Prevista de Término</label>
            <input class="form-control" id="previsao-termino" type="date" required/> <br>

            <label for="data-real-termino">Data Real de Término</label>
            <input class="form-control" id="data-real-termino" type="date" required/> <br>
            <hr>
